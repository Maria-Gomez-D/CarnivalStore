...
export default function CakeToppers({ onAddToCart }) { // Corregido para recibir props como objeto

    return (
        <div className="mt-14 mb-12">
            <div className="container">
                <div className="text-center mb-10 max-w-[600px] mx-auto">
                    <h1 className="text-3xl font-belvina text-darkblue">Cake Toppers</h1>
                </div>
                <div>
